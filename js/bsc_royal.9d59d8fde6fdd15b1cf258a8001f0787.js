...
async function main() {  
   ...
   const rewardsPerWeek = await CHEF.royalPerBlock() /1e18
    ...
    await loadBscChefContract(App, tokens, prices, CHEF, CHEF_ADDR, CHEF_ABI, rewardTokenTicker,
        "royal", null, rewardsPerWeek, "pendingEgg", [1]); // Yes it's called "pendingEgg"
